...
async function enrichKitsuEpisodes(metadata, imdbInfo, retrieveImdbMetadata) {
  ...
  const imdbMetadata = needsImdbMetadata && await retrieveImdbMetadata(imdbInfo.imdb_id, metadata.type).catch(
      () => undefined);
...
module.exports = { enrichKitsuMetadata, enrichImdbMetadata, hasImdbMapping };